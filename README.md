...
| Decide not to play again     | Enter n or N when asked to play again                                                                                      | A message appears thanking the user for playing.<br>The title of the game is displayed.<br>The user is prompted to enter a name.                                                                                                                                                                                                                               | PASS       |
...
| Space Validation             | Enter a trailing space after the last letter.<br>Enter a space between the names.<br>Enter a space before the first letter | The trailing space is ignored and the input is accepted.<br>The input is accepted with spacing between the names.<br>The space is ignored and the input is accepted                                                                                                                                                                                            | PASS       |
